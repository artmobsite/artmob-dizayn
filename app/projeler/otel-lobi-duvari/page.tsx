...
const HERO_IMG = "https://images.unsplash.com/photo-1560347876-aeef00ee58a1?auto=format&fit=crop&w=2400&q=85";
...
const PROJECT_INFO = {
  ...
  year: "2023",
  height: "18 Metre",
  type: "5 Yıldızlı Otel",
};

const APPLICATIONS = [
  {
    no: "01",
    title: "Büyük Ölçekli Ceviz Duvar Kaplaması",
    desc: "Otel lobisinin 18 metre yüksekliğindeki ana duvarı, koyu Amerikan cevizi kaplamalarla zemin kattan tavan ışıklığına kadar kesintisiz işlendi. Her panel, doğal damar yönünü koruyarak dikey süreklilik sağlayacak biçimde yerleştirildi.",
    specs: [{ l: "Malzeme", v: "Amerikan Cevizi" }, { l: "Yükseklik", v: "18 Metre" }, { l: "Alan", v: "420 m²" }],
  },
  {
    no: "02",
    title: "Bronz Profil Çerçeveleme Sistemi",
    desc: "Tüm panel birleşimlerinde fırçalanmış bronz profiller kullanıldı. Zemin seviyesinden başlayan profil sistemi, lobinin tüm yüksekliğinde dikey bir ritim oluşturarak beş yıldızlı mekânın kimliğini tanımladı.",
    specs: [{ l: "Profil", v: "Fırçalanmış Bronz" }, { l: "Aralık", v: "60 cm Modül" }, { l: "Montaj", v: "Görünmez Vida" }],
  },
  {
    no: "03",
    title: "Resepsiyon Tezgahı Yüzeyi",
    desc: "Resepsiyon tezgahının ön cephesi ve üst yüzeyi aynı Amerikan cevizi malzemesiyle kaplandı. Tezgah köşelerinde bronz profil detayları, duvar yüzeyiyle görsel bir bütünlük sağladı.",
    specs: [{ l: "Yüzey", v: "Mat Saten Cevizi" }, { l: "Detay", v: "Bronz Köşe Profil" }, { l: "Uzunluk", v: "8 Metre" }],
  },
  {
    no: "04",
    title: "Tavan Panel Sistemi ve Aydınlatma",
    desc: "Lobinin tavan yüzeyi ahşap yönlendirme lamellerinden oluşan akustik panel sistemiyle kaplandı. Lameller arasına entegre edilen LED aydınlatma, büyük duvar yüzeyini dramatik biçimde aydınlatarak mekânda derinlik yarattı.",
    specs: [{ l: "Tavan Sistemi", v: "Akustik Lamel" }, { l: "Işık", v: "Entegre LED" }, { l: "Renk", v: "2700K Sıcak Beyaz" }],
  },
];
...
const GALLERY = [
  {
    ...
    alt: "Otel Lobi — Ceviz Duvar Ana Görünüm",
    aspect: "aspect-[3/4]",
  },
  {
    src: "https://images.unsplash.com/photo-1631761481249-ecc8bd8f5cc0?auto=format&fit=crop&w=1200&q=85",
    alt: "Bronz Profil Detay",
    aspect: "aspect-square",
  },
  {
    src: "/images/felsefe-gorunmez-mukemmellik.jpg",
    alt: "Resepsiyon Tezgahı Yüzeyi",
    aspect: "aspect-[3/4]",
  },
  {
    src: "/images/sistem-02-gizli-depolama.jpg",
    alt: "Tavan Lamel Aydınlatma Sistemi",
    aspect: "aspect-square",
  },
];

const STATS = [
  { value: "18", unit: "m", label: "Duvar Yüksekliği" },
  { value: "420", unit: "m²", label: "Kaplanan Yüzey" },
  { value: "5", unit: "★", label: "Otel Sınıfı" },
  { value: "12", unit: "hf", label: "Proje Süresi" },
];
...
export default function OtelLobiDuvariPage() {
    ...
    <main className="bg-[#080806]">
      ...
      <section className="relative min-h-[92vh] flex flex-col justify-end pb-24 px-8 md:px-12 lg:px-16 xl:px-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-br from-[#2A2420] via-[#181410] to-[#080604]" />
          <Image
            src={HERO_IMG}
            alt="Otel Lobi Ceviz Duvar Yüzey Sistemi"
            fill
          ...
          <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 65% 50% at 65% 60%, rgba(196,169,106,0.07) 0%, transparent 65%)" }} />
        </div>
        ...
        <div className="relative z-20 w-full max-w-[1600px]">
          ...
          >
            {[
              ...
              { label: "Yükseklik", value: PROJECT_INFO.height },
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2">
        <div className="px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-20 md:py-32 border-b lg:border-b-0 lg:border-r border-stone/6">
          ...
          <ScrollReveal delay={0.1}>
            <h2 className="font-serif text-[clamp(28px,3.8vw,50px)] font-normal text-warm-white leading-tight mb-8">
              18 metrelik lobi duvarında<br />mimari bütünlük.
            </h2>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.22}>
            <p className="font-sans text-[13.5px] text-stone/60 font-light leading-[1.95] mb-6 max-w-lg">
              Nişantaşı&rsquo;nda yeni açılan beş yıldızlı otel için tasarlanan bu proje, lobinin 18 metre yüksekliğindeki ana duvarını koyu Amerikan cevizi kaplamayla tek bir mimari yüzeye dönüştürdü. Her panel, doğal damar sürekliğini koruyacak biçimde yerleştirildi.
            </p>
          </ScrollReveal>
          <ScrollReveal delay={0.28}>
            <p className="font-sans text-[13.5px] text-stone/60 font-light leading-[1.95] max-w-lg">
              Fırçalanmış bronz profil sistemi, resepsiyon tezgahı ve tavan lamel panelleriyle projenin tüm yüzeyleri birbiriyle diyalog kuran tek bir dil oluşturdu. Entegre aydınlatma, akşam saatlerinde mekânı tamamen farklı bir atmosfere büründürüyor.
            </p>
          </ScrollReveal>
        </div>
        ...
        <div className="px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-20 md:py-32">
          ...
          <div className="space-y-8">
            {[
              "Büyük Ölçekli Amerikan Cevizi Kaplama",
              "Fırçalanmış Bronz Profil Çerçeveleme",
              "Resepsiyon Tezgahı Cevizi Yüzey",
              "Akustik Tavan Lamel Sistemi",
              "Entegre LED Aydınlatma Hattı",
              "Endüstriyel Görünmez Montaj Sistemi",
            ].map((item, i) => (
      ...
      <div className="relative h-[38vw] max-h-[480px] overflow-hidden my-4 mx-8 md:mx-12 lg:mx-16">
        <Image
          ...
          alt="Büyük ölçekli yüzey montaj detayı"
          fill
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-8">
            ...
            <p className="font-serif text-[clamp(22px,3.5vw,52px)] font-normal text-warm-white/88 leading-tight max-w-2xl mx-auto">
              18 metre yükseklikte<br />tek bir mimari yüzey bütünlüğü
            </p>
          </div>
        </div>
